...
var $author$project$Anagram$isAnagram = F2(
	function (test, givenWord) {
		var sortedWord = $elm$core$List$sort(
			$elm$core$String$toList(
				$elm$core$String$toLower(givenWord)));
		var sortedTest = $elm$core$List$sort(
			$elm$core$String$toList(
				$elm$core$String$toLower(test)));
		return _Utils_eq(sortedTest, sortedWord);
	});
	...
	function (word, candidates) {
		...
		while (true) {
			...
			if (!candidates.b) {
				...
				var x = candidates.a;
				var xs = candidates.b;
				if (A2($author$project$Anagram$isAnagram, x, word)) {
					return A2($elm$core$List$cons, x, res);
				} else {
					var $temp$word = word,
						$temp$candidates = xs;
					word = $temp$word;
...
var $author$project$Test$Generated$Main3249336933$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/anagram/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main3249336933':{'init':$author$project$Test$Generated$Main3249336933$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-24637.sock";
