...
var $author$project$Bob$Question = {$: 'Question'};
var $author$project$Bob$Shout = {$: 'Shout'};
var $author$project$Bob$ShoutQuestion = {$: 'ShoutQuestion'};
var $author$project$Bob$Silence = {$: 'Silence'};
var $author$project$Bob$Whatever = {$: 'Whatever'};
var $elm$core$String$endsWith = _String_endsWith;
var $author$project$Bob$isQuestion = function (string) {
	return A2(
...
var $author$project$Bob$isAlpha = function (_char) {
	return $elm$core$Char$isUpper(_char) || $elm$core$Char$isLower(_char);
};
var $elm$core$String$toUpper = _String_toUpper;
var $author$project$Bob$isShouting = function (string) {
	return _Utils_eq(
		string,
		$elm$core$String$toUpper(string)) && A2($elm$core$String$any, $author$project$Bob$isAlpha, string);
};
var $author$project$Bob$isWhitespace = function (string) {
	return $elm$core$String$isEmpty(
		$elm$core$String$trim(string));
};
var $author$project$Bob$hey = function (words) {
	var question = $author$project$Bob$isShouting(words) ? ($author$project$Bob$isQuestion(words) ? $author$project$Bob$ShoutQuestion : $author$project$Bob$Shout) : ($author$project$Bob$isQuestion(words) ? $author$project$Bob$Question : ($author$project$Bob$isWhitespace(words) ? $author$project$Bob$Silence : $author$project$Bob$Whatever));
	switch (question.$) {
		case 'ShoutQuestion':
...
var $author$project$Test$Generated$Main1176730657$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/bob/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main1176730657':{'init':$author$project$Test$Generated$Main1176730657$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-35364.sock";
