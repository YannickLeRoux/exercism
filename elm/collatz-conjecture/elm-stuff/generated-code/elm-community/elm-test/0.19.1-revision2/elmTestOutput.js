...
var $author$project$CollatzConjecture$recurse = function (num) {
	if (num === 1) {
		return 0;
	} else {
		var n = num;
		var _v1 = n % 2;
		if (!_v1) {
			return $author$project$CollatzConjecture$recurse((n / 2) | 0) + 1;
		} else {
			return $author$project$CollatzConjecture$recurse((3 * n) + 1) + 1;
		}
	}
};
var $author$project$CollatzConjecture$collatz = function (start) {
	return (start < 1) ? $elm$core$Result$Err('Only positive numbers are allowed') : $elm$core$Result$Ok(
		$author$project$CollatzConjecture$recurse(start));
};
...
var $author$project$Test$Generated$Main1759800000$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/collatz-conjecture/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main1759800000':{'init':$author$project$Test$Generated$Main1759800000$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-34491.sock";
