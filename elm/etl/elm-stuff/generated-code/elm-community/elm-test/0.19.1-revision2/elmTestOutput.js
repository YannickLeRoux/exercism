...
var $author$project$Etl$pair = function (_v0) {
	var key = _v0.a;
	var values = _v0.b;
	return A2(
		$elm$core$List$map,
		function (v) {
			return _Utils_Tuple2(
				$elm$core$String$toLower(v),
				key);
		},
		values);
};
var $author$project$Etl$transform = A2(
	$elm$core$Basics$composeR,
	$elm$core$Dict$toList,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$List$concatMap($author$project$Etl$pair),
...
var $author$project$Test$Generated$Main2954171129$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/etl/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 377872566922248
	},
...
_Platform_export({'Test':{'Generated':{'Main2954171129':{'init':$author$project$Test$Generated$Main2954171129$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-19693.sock";
