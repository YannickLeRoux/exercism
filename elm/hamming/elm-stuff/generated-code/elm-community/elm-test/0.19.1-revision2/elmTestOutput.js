...
var $author$project$Hamming$count = F2(
	function (_v0, dist) {
		var a = _v0.a;
		var b = _v0.b;
		return (!_Utils_eq(a, b)) ? (dist + 1) : dist;
	});
var $author$project$Hamming$solveDistance = F2(
	function (l, r) {
		return A3(
			$elm$core$List$foldl,
			$author$project$Hamming$count,
			0,
			A3(
				$elm$core$List$map2,
				$elm$core$Tuple$pair,
				$elm$core$String$toList(l),
				$elm$core$String$toList(r)));
	});
var $author$project$Hamming$distance = F2(
	function (left, right) {
		return _Utils_eq(
			$elm$core$String$length(left),
			$elm$core$String$length(right)) ? $elm$core$Result$Ok(
			A2($author$project$Hamming$solveDistance, left, right)) : $elm$core$Result$Err('left and right strands must be of equal length');
	});
...
var $author$project$Test$Generated$Main4226563120$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/hamming/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 157925714945487
	},
...
_Platform_export({'Test':{'Generated':{'Main4226563120':{'init':$author$project$Test$Generated$Main4226563120$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-12005.sock";
