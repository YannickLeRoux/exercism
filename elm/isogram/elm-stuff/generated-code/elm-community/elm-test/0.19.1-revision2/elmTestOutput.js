...
var $author$project$Isogram$isIsogram = function (sentence) {
	var lowerS = $elm$core$String$toLower(sentence);
	return _Utils_eq(
		$elm$core$Set$size(
			$elm$core$Set$fromList(
				$elm$core$String$toList(lowerS))),
		$elm$core$String$length(lowerS));
};
...
var $author$project$Test$Generated$Main2465315906$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/isogram/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 218240043605139
	},
...
_Platform_export({'Test':{'Generated':{'Main2465315906':{'init':$author$project$Test$Generated$Main2465315906$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-16945.sock";
