...
var $author$project$Leap$isLeapYear = function (year) {
	var isYearDivBy = function (div) {
		return !(year % div);
	};
	return (isYearDivBy(4) && (!isYearDivBy(100))) || isYearDivBy(400);
};
...
var $author$project$Test$Generated$Main4052534544$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/leap/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 198665945787550
	},
...
_Platform_export({'Test':{'Generated':{'Main4052534544':{'init':$author$project$Test$Generated$Main4052534544$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-14164.sock";
