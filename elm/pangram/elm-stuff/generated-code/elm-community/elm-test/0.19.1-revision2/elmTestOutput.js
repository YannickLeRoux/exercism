...
var $author$project$Pangram$alphabet = _List_fromArray(
	[
		_Utils_chr('a'),
		_Utils_chr('b'),
		_Utils_chr('c'),
...
var $author$project$Pangram$isPangram = function (sentence) {
	...
	return A2(
		$elm$core$List$all,
		function (x) {
			return A2($elm$core$List$member, x, sentenceList);
		},
...
var $author$project$Test$Generated$Main2119979478$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/pangram/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 162057134158622
	},
...
_Platform_export({'Test':{'Generated':{'Main2119979478':{'init':$author$project$Test$Generated$Main2119979478$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-71046.sock";
