...
var $author$project$RobotSimulator$East = {$: 'East'};
var $author$project$RobotSimulator$North = {$: 'North'};
var $author$project$RobotSimulator$Robot = F2(
	function (bearing, coordinates) {
		return {bearing: bearing, coordinates: coordinates};
	});
var $author$project$RobotSimulator$South = {$: 'South'};
var $author$project$RobotSimulator$West = {$: 'West'};
var $author$project$RobotSimulator$advance = function (robot) {
	var coord = robot.coordinates;
	var _v0 = robot.bearing;
	switch (_v0.$) {
		case 'North':
			var newCoord = _Utils_update(
				coord,
				{y: coord.y + 1});
			return _Utils_update(
				robot,
...
var $author$project$Tests$assertionList = F2(
	function (xs, ys) {
		return A3($elm$core$List$map2, $elm_explorations$test$Expect$equal, xs, ys);
	});
var $author$project$RobotSimulator$defaultRobot = {
	bearing: $author$project$RobotSimulator$North,
	coordinates: {x: 0, y: 0}
};
var $author$project$Tests$scanl = F3(
	function (f, b, xs) {
		var scan1 = F2(
			function (x, accAcc) {
				if (accAcc.b) {
...
var $author$project$RobotSimulator$turnLeft = function (robot) {
	var _v0 = robot.bearing;
	switch (_v0.$) {
		case 'North':
			return _Utils_update(
				robot,
				{bearing: $author$project$RobotSimulator$West});
		case 'South':
			return _Utils_update(
				robot,
				{bearing: $author$project$RobotSimulator$East});
		case 'East':
			return _Utils_update(
				robot,
				{bearing: $author$project$RobotSimulator$North});
		default:
			return _Utils_update(
				robot,
				{bearing: $author$project$RobotSimulator$South});
	}
};
var $author$project$RobotSimulator$turnRight = function (robot) {
	var _v0 = robot.bearing;
	switch (_v0.$) {
		case 'North':
			return _Utils_update(
...
var $author$project$RobotSimulator$move = F2(
	function (c, r) {
		switch (c.valueOf()) {
			case 'L':
				return $author$project$RobotSimulator$turnLeft(r);
			case 'R':
				return $author$project$RobotSimulator$turnRight(r);
			case 'A':
				return $author$project$RobotSimulator$advance(r);
			default:
				return r;
		}
	});
var $author$project$RobotSimulator$simulate = F2(
	function (directions, robot) {
		return A3(
			$elm$core$List$foldl,
			$author$project$RobotSimulator$move,
			robot,
			$elm$core$String$toList(directions));
	});
...
var $author$project$Tests$tests = A2(
	...
	_List_fromArray(
		[
			...
			'init',
			function () {
				var robot = $author$project$RobotSimulator$defaultRobot;
				return _List_fromArray(
					[
						A2(
						...
						'bearing',
						function (_v1) {
							return A2($elm_explorations$test$Expect$equal, $author$project$RobotSimulator$North, robot.bearing);
						})
					]);
			}()),
			A2(
			...
			function () {
				var robot = A2(
					$author$project$RobotSimulator$Robot,
					$author$project$RobotSimulator$South,
					{x: -1, y: 1});
				return _List_fromArray(
					[
						A2(
						...
						'bearing',
						function (_v3) {
							return A2($elm_explorations$test$Expect$equal, $author$project$RobotSimulator$South, robot.bearing);
						})
					]);
			}()),
			A2(
			...
			A2(
				...
				F2(
					function (i, e) {
						return A2(
							$elm_explorations$test$Test$test,
							'step ' + $elm$core$String$fromInt(i),
							function (_v5) {
								return e;
							});
					}),
				A2(
					$author$project$Tests$assertionList,
					_List_fromArray(
						[$author$project$RobotSimulator$North, $author$project$RobotSimulator$East, $author$project$RobotSimulator$South, $author$project$RobotSimulator$West]),
					A2(
						$elm$core$List$map,
						function ($) {
							return $.bearing;
						...
						A3(
							$author$project$Tests$scanl,
							F2(
								function (_v4, r) {
									return $author$project$RobotSimulator$turnRight(r);
								}),
							$author$project$RobotSimulator$defaultRobot,
			...
			A2(
				...
				A2(
					$author$project$Tests$assertionList,
					_List_fromArray(
						[$author$project$RobotSimulator$North, $author$project$RobotSimulator$West, $author$project$RobotSimulator$South, $author$project$RobotSimulator$East]),
					A2(
						$elm$core$List$map,
						function ($) {
							return $.bearing;
			...
			function () {
				var robot = $author$project$RobotSimulator$advance(
					A2(
						$author$project$RobotSimulator$Robot,
						$author$project$RobotSimulator$North,
						{x: 0, y: 0}));
				return _List_fromArray(
					[
						A2(
			...
			function () {
				var robot = $author$project$RobotSimulator$advance(
					A2(
						$author$project$RobotSimulator$Robot,
						$author$project$RobotSimulator$East,
						{x: 0, y: 0}));
				return _List_fromArray(
					[
						A2(
						...
						'bearing',
						function (_v11) {
							return A2($elm_explorations$test$Expect$equal, $author$project$RobotSimulator$East, robot.bearing);
						})
					]);
			}()),
			A2(
			...
			function () {
				var robot = $author$project$RobotSimulator$advance(
					A2(
						$author$project$RobotSimulator$Robot,
						$author$project$RobotSimulator$West,
						{x: 0, y: 0}));
				return _List_fromArray(
					[
						A2(
						...
						'bearing',
						function (_v15) {
							return A2($elm_explorations$test$Expect$equal, $author$project$RobotSimulator$West, robot.bearing);
						})
					]);
			}()),
			A2(
			...
			function () {
				var robot = A2(
					$author$project$RobotSimulator$simulate,
					'LAAARALA',
					A2(
						$author$project$RobotSimulator$Robot,
						$author$project$RobotSimulator$North,
...
var $author$project$Test$Generated$Main1695446480$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/yannickleroux/Code/Learning/Exercism/elm/robot-simulator/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 279795272952159
	},
...
_Platform_export({'Test':{'Generated':{'Main1695446480':{'init':$author$project$Test$Generated$Main1695446480$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-23527.sock";
